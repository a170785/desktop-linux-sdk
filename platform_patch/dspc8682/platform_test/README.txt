...
1) In order to build the project in CCSv5, perform the following steps:
   ...
   (4) Mark 'Select root directory' option and browse to the project directory on 
       harddisk (pdk_#_##_##_##\packages\ti\platform\dspc8682\platform_test).
   ...
   (6) Mark on the project 'platform_test_dspc8682' and click on Finish option.
...
3) Now select the 'platform_test_dspc8682' project in 'C/C++ Projects' window of CCSv5 IDE. Right click 
...
7) There is a test configuration file pdk_#_##_##_##\\packages\ti\platform\dspc8682\platform_test\testconfig 
